...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CArf5Ysw.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CR5GPaPJ.css";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				className: `hidden md:fixed md:inset-y-0 md:left-0 md:flex md:flex-col md:pt-6 bg-[#FFFFFF] border-r border-[#E5E7EB] transition-all duration-300 ease-out ${sidebarCollapsed ? "md:w-[80px]" : "md:w-[240px]"}`,
							...
							children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: INBOX_CONVERSATIONS.filter((conversation) => {
													...
													if (activeTab === "Owner") return src === "owner";
													return true;
													...
													return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																	className: "flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#22C55E] text-sm font-semibold text-white",
																	children: conversation.avatar
																}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																	className: "min-w-0",
																	children: [conversation.isSaved && conversation.name ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																		className: "flex flex-wrap items-center gap-2",
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																			className: "min-w-0 text-base font-medium text-[#111827] truncate",
																			title: conversation.name,
																			children: conversation.name.length > 22 ? `${conversation.name.slice(0, 22)}…` : conversation.name
																		}), effectiveSource === "needs_attention" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
																			className: "inline-flex items-center gap-1 rounded-full bg-[#fee2e2] px-2 py-1 text-xs font-semibold text-[#b91c1c]",
																	...
																	}) : effectiveSource === "ai_handled" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
																		className: "inline-flex mt-1 items-center gap-1 rounded-full bg-[#F0FDF4] px-2 py-1 text-xs font-semibold text-[#14532d]",
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																			"aria-hidden": true,
																			children: "🤖"
																		}), "AI Handled"]
																	}) : effectiveSource === "owner" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
																		className: "inline-flex mt-1 items-center gap-1 rounded-full bg-[#EFF6FF] px-2 py-1 text-xs font-semibold text-[#1E3A8A]",
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																			"aria-hidden": true,
																			children: "👤"
																		}), "Owner"]
																	}) : effectiveSource !== "needs_attention" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																...
																className: "inline-flex rounded-full bg-[#F0FDF4] px-2 py-1 text-xs font-semibold text-[#14532d]",
																children: "🤖 AI Handled"
															}) : effectiveSource === "needs_attention" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																className: "inline-flex rounded-full bg-[#FEF2F2] px-2 py-1 text-xs font-semibold text-[#B91C1C]",
																children: "🔴 Needs Owner"
															}) : effectiveSource === "owner" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																className: "inline-flex rounded-full bg-[#EFF6FF] px-2 py-1 text-xs font-semibold text-[#1E3A8A]",
																children: "👤 Owner"
															}) : null]
														})]
													}, conversation.id);
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													...
													children: effectiveActiveSource.startsWith("ai") ? effectiveActiveSource === "ai_handling" ? "🤖 AI ON" : "🤖 AI Handled" : effectiveActiveSource === "needs_attention" ? "🔴 Needs Owner" : "👤 Owner Mode"
										...
										className: "flex min-h-0 flex-1 flex-col p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex-1 min-h-0 space-y-4 overflow-y-auto pr-2 pb-4 custom-scrollbar",
											...
											className: "sticky bottom-0 z-10 mt-4 bg-white/95 pt-4 pb-4 backdrop-blur-sm",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "rounded-[20px] border border-[#E5E7EB] bg-white p-3 shadow-sm",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								!customerCollapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
									className: `${CARD} h-full min-h-0 flex flex-col self-stretch overflow-hidden transition-opacity duration-300 ease-out opacity-100 p-6`,
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													...
													children: activeCustomerProfile.interestedProducts.map((product) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																...
																className: "mt-2 text-sm text-[#6B7280]",
																children: "Send a sample prompt and preview how the assistant responds to common customer questions."
															})] }),
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																className: "space-y-3 rounded-3xl bg-[#F9FAFB] p-5",
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																	className: "rounded-3xl bg-white p-4 text-sm text-[#111827] shadow-sm",
																	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																		className: "font-semibold",
																		children: "Customer"
																	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																		className: "mt-2 text-[#6B7280]",
																		children: testAiInput
																	})]
																}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																	className: "rounded-3xl bg-[#ECFDF5] p-4 text-sm text-[#166534] shadow-sm",
																	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																		className: "font-semibold",
																		children: "AI Assistant"
																	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																		className: "mt-2",
																		children: "This is a mock reply based on your current AI settings and business knowledge."
																	})]
																})]
															}),
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																className: "rounded-3xl border border-[#E5E7EB] bg-[#F9FAFB] p-5",
																children: [
											...
											assistantTab === "Conversation Policies" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "text-sm font-semibold text-[#111827]",
															children: "Conversation policies"
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "mt-2 text-sm text-[#6B7280]",
															children: "Keep your AI responses aligned with business expectations and customer experience."
														})]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: "rounded-3xl border border-[#E5E7EB] bg-white p-5 shadow-sm",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																className: "text-sm font-semibold text-[#111827]",
																children: "Keep replies concise"
															}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																className: "mt-1 text-sm text-[#6B7280]",
																children: "Short answers make it easier for customers to scan messages on mobile."
															})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
																type: "button",
																onClick: () => setPolicyKeepShort((value) => !value),
																className: `rounded-full px-4 py-2 text-sm font-semibold transition ${policyKeepShort ? "bg-[#DCFCE7] text-[#166534]" : "bg-[#E5E7EB] text-[#6B7280]"}`,
																children: policyKeepShort ? "On" : "Off"
															})]
														})
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														...
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																className: "text-sm font-semibold text-[#111827]",
																children: "Use polite and professional language"
															}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																className: "mt-1 text-sm text-[#6B7280]",
																children: "Avoid slang and keep the business tone respectful."
															})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
																type: "button",
																onClick: () => setPolicyUseProfessionalTone((value) => !value),
																className: `rounded-full px-4 py-2 text-sm font-semibold transition ${policyUseProfessionalTone ? "bg-[#DCFCE7] text-[#166534]" : "bg-[#E5E7EB] text-[#6B7280]"}`,
																children: policyUseProfessionalTone ? "On" : "Off"
															})]
														})
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														...
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																className: "text-sm font-semibold text-[#111827]",
																children: "Respect business hours"
															}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																className: "mt-1 text-sm text-[#6B7280]",
																children: "Let customers know when the business will return outside operating hours."
															})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
																type: "button",
																onClick: () => setPolicyRespectHours((value) => !value),
																className: `rounded-full px-4 py-2 text-sm font-semibold transition ${policyRespectHours ? "bg-[#DCFCE7] text-[#166534]" : "bg-[#E5E7EB] text-[#6B7280]"}`,
																children: policyRespectHours ? "On" : "Off"
															})]
														})
													})
												]
