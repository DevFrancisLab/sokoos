...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DngXBaE-.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CyT7Cjhe.css";
...
var CARD = "rounded-[20px] bg-white p-7 shadow-[0_10px_30px_rgba(2,6,23,0.04)] transition-shadow duration-200 hover:shadow-[0_12px_36px_rgba(2,6,23,0.05)]";
var SECTION_HEADING = "text-xs font-medium uppercase tracking-[0.12em] text-[#6B7280]";
var CARD_TITLE = "text-[28px] font-bold mb-6 text-[#111827]";
var CUSTOMER_NAME = "text-lg font-semibold text-[#111827]";
var SECONDARY = "text-sm text-[#6B7280]";
var MESSAGE_PREVIEW = "text-sm text-[#374151]";
var TIME_LABEL = "text-xs text-[#6B7280]";
var RECENT_ACTIVITY = [
	{
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: RECENT_ACTIVITY.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "rounded-[20px] bg-[#F9FAFB] p-7 transition hover:bg-[#ECFDF5]",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mb-4 rounded-[20px] bg-[#F9FAFB] px-6 py-3",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: INBOX_CONVERSATIONS.filter((conversation) => {
													...
													return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
														...
														className: `w-full overflow-hidden rounded-[20px] p-6 text-left transition-colors duration-150 flex flex-col justify-between min-h-[92px] ${active ? "bg-[#ECFDF5] ring-1 ring-[#22C55E]/30 shadow-[0_8px_24px_rgba(34,197,94,0.06)]" : "bg-white hover:bg-[#F7FBF7]"}`,
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															className: "flex items-start justify-between gap-3",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																className: "flex items-start gap-3 min-w-0",
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																	className: "flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-[#22C55E] text-sm font-semibold text-white",
																	...
																	children: [conversation.isSaved && conversation.name ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																		...
																		children: [
																			effectiveSource === "needs_attention" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
																				className: "inline-flex items-center gap-1 rounded-full bg-[#FEF2F2] px-2 py-0.5 text-xs font-semibold text-[#B91C1C]",
																			...
																			effectiveSource === "personal" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																				className: "inline-flex items-center gap-1 rounded-full bg-[#F1F5F9] px-2 py-0.5 text-xs font-semibold text-[#6B7280]",
																				children: "👤 Personal"
																			}),
																			effectiveSource === "ai_handling" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																				className: "inline-flex items-center gap-1 rounded-full bg-[#ECFDF5] px-2 py-0.5 text-xs font-semibold text-[#166534]",
																				children: "🤖 AI Handling"
																			}),
																			effectiveSource === "ai_handled" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																				className: "inline-flex items-center gap-1 rounded-full bg-[#F0FDF4] px-2 py-0.5 text-xs font-semibold text-[#14532d]",
																				children: "🤖 AI Handled"
																			}),
																			effectiveSource === "owner" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																				className: "inline-flex items-center gap-1 rounded-full bg-[#EFF6FF] px-2 py-0.5 text-xs font-semibold text-[#1E3A8A]",
																				children: "👤 You"
																			})
																		]
																	})]
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																...
																children: conversation.badge > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																	className: "inline-flex items-center justify-center rounded-full bg-[#22C55E] px-2 py-0.5 text-[10px] font-semibold text-white",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: activeMessages.map((message, index) => {
												...
												return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [isAgent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														...
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															className: `rounded-[16px] px-5 py-4 text-sm max-w-[78%] break-words ${isAgent ? isAi ? "bg-[#ECFDF5] text-[#064E3B]" : "bg-[#F3F4F6] text-[#111827]" : "bg-white text-[#111827] border border-[#E5E7EB]/20 shadow-[0_6px_18px_rgba(2,6,23,0.03)]"}`,
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "rounded-[20px] bg-white p-6 shadow-[0_6px_18px_rgba(16,24,40,0.04)] border border-[#E5E7EB]/10",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															...
															className: "inline-flex items-center gap-2 rounded-full bg-[#EFF6FF] px-3 py-1 text-xs font-semibold text-[#1E40AF]",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																"aria-hidden": true,
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																...
																className: "rounded-full bg-[#ECFDF5] px-2.5 py-1 text-xs font-semibold text-[#16A34A]",
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																...
																children: activeCustomerProfile.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																	className: "inline-flex items-center rounded-full bg-[#F1F5F9] px-2.5 py-1 text-xs font-medium text-[#334155]",
																	children: tag
																}, tag))
															})]
														})]
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														...
														children: activeCustomerProfile.interestedProducts.map((product) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
															className: "rounded-xl bg-[#F8FAFC] px-3 py-2 text-sm text-[#111827]",
															children: product
														}, product))
													})]
												})]
