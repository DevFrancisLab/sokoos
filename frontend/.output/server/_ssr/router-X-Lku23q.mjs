...
//#region node_modules/.nitro/vite/services/ssr/assets/router-X-Lku23q.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-9IXDqi63.css";
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: `flex-1 overflow-y-auto transition-all duration-300 ${sidebarCollapsed ? "px-1" : "px-3"}`,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: NAV_ITEMS.map(({ label, href, Icon }) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								title: label,
								"aria-label": label,
								className: `w-full flex items-center gap-3 rounded-2xl py-2 text-sm font-medium transition duration-200 ${sidebarCollapsed ? "justify-center" : "justify-start px-3"} ${active ? "bg-[#ECFDF5] text-[#065F46] shadow-sm ring-1 ring-[#D1FAE5]" : "text-[#475569] hover:bg-[#F8FAFC] hover:text-[#111827]"}`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: `h-4 w-4 ${active ? "text-[#059669] opacity-100" : "text-[#6B7280] opacity-90"}` }), !sidebarCollapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label })]
							}) }, href);
						})
					})
				})]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: NAV_ITEMS.map(({ label, href, Icon }) => {
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: `w-full text-left flex items-center gap-3 rounded-2xl px-3 py-2 text-sm font-medium transition duration-200 ${selected === label ? "bg-[#ECFDF5] text-[#065F46] shadow-sm ring-1 ring-[#D1FAE5]" : "text-[#475569] hover:bg-[#F8FAFC] hover:text-[#111827]"}`,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						selected === "Inbox" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "border-b border-[#E5E7EB]/20 px-5 py-4",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "flex items-center justify-between gap-3",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mb-5 rounded-[22px] bg-[#F3F4F6] px-6 py-4 shadow-sm shadow-slate-200/60 ring-1 ring-[#D1D5DB]/40 transition duration-200 ease-out focus-within:ring-2 focus-within:ring-slate-200",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																	...
																	children: [conversation.isSaved && conversation.name ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																		...
																		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
																			className: `${BADGE} mt-2 ${badge.bg} ${badge.text}`,
																			children: [
																				badge.emoji,
																				" ",
																				badge.label
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													(() => {
														...
														return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
															className: `inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold mt-2 ${badge.bg} ${badge.text}`,
															children: [
																badge.emoji,
																" ",
																badge.label
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "rounded-[22px] bg-[#F8FAFB]/85 p-4 border border-[#E5E7EB]/10 shadow-[0_4px_12px_rgba(15,23,42,0.04)]",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "flex items-center gap-3",
								...
								!customerCollapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "space-y-6 rounded-[22px] border border-[#E5E7EB]/10 bg-white p-6 shadow-[0_8px_24px_rgba(15,23,42,0.04)]",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className: "space-y-2",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															...
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: [
																	...
																	/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																		className: "text-lg font-semibold text-[#0F172A] truncate",
																		children: activeCustomerProfile.name
																	}),
																	/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
															...
															}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: isPersonalActive ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																className: "rounded-lg border border-[#E5E7EB]/20 bg-[#F9FAFB] p-4",
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															...
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																	className: "text-sm font-semibold text-[#334155]",
																	children: "What does the customer want?"
																}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																	className: "mt-2 text-sm text-[#475569]",
																	children: (() => {
															...
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																	className: "text-sm font-semibold text-[#334155]",
																	children: "What did the AI already do?"
																}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																	className: "mt-2 text-sm text-[#475569] space-y-1",
																	children: (() => {
																		const aiReplies = activeMessages.filter((m) => m.from === "agent").slice(-3);
																		if (!aiReplies.length) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "No AI replies recorded." });
																		return aiReplies.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																			className: "",
																			children: r.text
																		}, i));
																	})()
															...
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																	...
																	className: "mt-2 list-disc list-inside text-sm text-[#475569] space-y-1",
																	children: (() => {
																		const text = activeMessages.map((m) => m.text).join(" ").toLowerCase();
																		if (text.includes("price") || text.includes("pricing")) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Confirm exact product and send a price list." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Offer a limited-time discount to close the sale." })] });
																		if (text.includes("install") || text.includes("installation")) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Propose two installation time slots." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Confirm any preparatory requirements." })] });
																		if (text.includes("cancel")) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Confirm cancellation reason and retention offer." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Escalate to human support if needed." })] });
																		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Ask a clarifying question to confirm the customer's intent." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Summarize the customer's request and propose next steps." })] });
																	})()
																})]
															})
														]
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: scheduledPosts.map((post) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "rounded-[22px] border border-[#E5E7EB]/70 bg-[#F8FAFC]/70 p-4",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						selected === "Broadcasts" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "p-6 bg-white rounded-[22px] border border-[#E5E7EB]/30 shadow-[0_6px_18px_rgba(16,24,40,0.04)]",
