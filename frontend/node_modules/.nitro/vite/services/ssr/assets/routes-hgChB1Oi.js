...
import { ArrowRight, BarChart3, Bot, Boxes, Brain, Calendar, Check, Clock, Database, Facebook, Heart, Inbox, Linkedin, MessageCircle, MessageSquareOff, Package, Plug, RefreshCw, Repeat, Rocket, Sparkles, Star, Users } from "lucide-react";
//#region src/assets/hero-dashboard.png
var hero_dashboard_default = "/assets/hero-dashboard-D-CXLQyc.png";
//#endregion
//#region src/assets/solution-dashboard.png
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      ` }),
		/* @__PURE__ */ jsxs("div", {
			...
			children: [!isChatOpen && /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-full border border-[#22C55E]/20" }),
					/* @__PURE__ */ jsx("div", { className: "absolute -bottom-0.5 -right-0.5 h-4.5 w-4.5 rounded-full border-2 border-white bg-[#22C55E] shadow-sm" }),
					/* @__PURE__ */ jsx("span", {
						className: "text-3xl",
						children: "🤖"
					})
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [/* @__PURE__ */ jsx("p", {
								...
								children: "Sokoos AI"
							}), /* @__PURE__ */ jsx("span", { className: "h-2.5 w-2.5 rounded-full bg-[#22C55E]" })]
						}), /* @__PURE__ */ jsx("p", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							className: "space-y-3",
							children: [
								messages.map((entry) => /* @__PURE__ */ jsx("div", {
								...
								messages.length === 1 && /* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("p", {
											...
											children: suggestedQuestions.map((suggestion) => /* @__PURE__ */ jsx("button", {
												type: "button",
			...
			children: [
				/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("p", {
							...
							children: ["Your AI employee that acquires customers, converts leads into customers, and keeps them coming back, ", /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("span", {
									...
									children: [/* @__PURE__ */ jsx(BarChart3, { className: "h-4 w-4 text-[#16A34A]" }), "Acquire Customers"]
								}),
								/* @__PURE__ */ jsx("span", {
								...
								/* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-2 text-[#166534]",
									children: [/* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4 text-[#16A34A]" }), "Convert Leads"]
								}),
								/* @__PURE__ */ jsx("span", {
									className: "hidden sm:inline",
									children: "→"
								...
								/* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-2 text-[#166534]",
									children: [/* @__PURE__ */ jsx(Heart, { className: "h-4 w-4 text-[#16A34A]" }), "Retain Customers"]
								})
							]
						})
					]
				...
				/* @__PURE__ */ jsx(Reveal, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-x-8 top-8 -z-10 h-full rounded-3xl bg-primary/10 blur-3xl" }), /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: [
								...
								"Real Estate",
								"Restaurants"
							].map((s, i) => /* @__PURE__ */ jsxs("span", {
								className: "flex items-center gap-3",
								children: [i > 0 && /* @__PURE__ */ jsx("span", { className: "h-1 w-1 rounded-full bg-border" }), s]
							}, s))
						})]
					})
				})
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsxs("h2", {
						className: "mt-3 text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl",
						children: ["How ", /* @__PURE__ */ jsx("span", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "relative",
						children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-4 -z-10 rounded-3xl bg-primary/10 blur-3xl" }), /* @__PURE__ */ jsx("div", {
							className: "overflow-hidden rounded-2xl border border-border bg-white shadow-[var(--shadow-elevated)]",
							children: /* @__PURE__ */ jsx("img", {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(SectionHeader, {
				...
				children: [
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", { className: "absolute -right-6 -top-6 h-24 w-24 rounded-full bg-primary/5 transition-transform group-hover:scale-125" }), /* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [
								/* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(SectionHeader, {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "absolute left-8 right-8 top-6 hidden h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent md:block" }), [
					{
						icon: Plug,
				...
				children: [
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							t.cta === "Get Started" ? /* @__PURE__ */ jsxs(Link, {
								to: "/sign-up",
								...
								children: [t.cta, /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							}) : /* @__PURE__ */ jsxs("a", {
								href: "#",
								className: `mt-8 inline-flex items-center justify-center gap-1.5 rounded-xl px-4 py-3 text-sm font-semibold transition-colors ${t.highlight ? "bg-primary text-primary-foreground hover:bg-primary/90" : "bg-foreground text-background hover:bg-foreground/90"}`,
								children: [t.cta, /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "absolute -right-24 -top-24 h-64 w-64 rounded-full bg-primary/30 blur-3xl" }),
					/* @__PURE__ */ jsx("div", { className: "absolute -bottom-24 -left-24 h-64 w-64 rounded-full bg-primary/20 blur-3xl" }),
					/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx("footer", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				].map((col) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
					className: "text-sm font-semibold",
					children: col.title
				}), /* @__PURE__ */ jsx("ul", {
					className: "mt-4 space-y-3",
					children: col.links.map(([label, href]) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", {
						href,
				...
				] }), /* @__PURE__ */ jsx("span", { children: "Made for modern businesses." })]
			})]
		})
	});
}
