					...
					children: /* @__PURE__ */ jsx("ul", {
						...
						children: NAV_ITEMS.map(({ label, href, Icon }) => {
							...
							return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Icon, { className: `h-4 w-4 ${active ? "text-[#059669] opacity-100" : "text-[#6B7280] opacity-90"}` }), !sidebarCollapsed && /* @__PURE__ */ jsx("span", { children: label })]
							}) }, href);
						})
					})
				})]
												...
												children: [
													/* @__PURE__ */ jsxs("div", {
														...
														children: [/* @__PURE__ */ jsx("p", {
															...
															}), /* @__PURE__ */ jsx("div", { children: isPersonalActive ? /* @__PURE__ */ jsxs("span", {
														...
														children: [
															...
															/* @__PURE__ */ jsxs("div", {
																...
																children: [/* @__PURE__ */ jsx("p", {
																	...
																	children: (() => {
																		...
																		if (!aiReplies.length) return /* @__PURE__ */ jsx("div", { children: "No AI replies recorded." });
																		return aiReplies.map((r, i) => /* @__PURE__ */ jsx("div", {
																			className: "",
																			children: r.text
																		}, i));
																	})()
															...
															/* @__PURE__ */ jsxs("div", {
																...
																children: [/* @__PURE__ */ jsx("p", {
																	...
																	children: (() => {
																		const text = activeMessages.map((m) => m.text).join(" ").toLowerCase();
																		if (text.includes("price") || text.includes("pricing")) return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("li", { children: "Confirm exact product and send a price list." }), /* @__PURE__ */ jsx("li", { children: "Offer a limited-time discount to close the sale." })] });
																		if (text.includes("install") || text.includes("installation")) return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("li", { children: "Propose two installation time slots." }), /* @__PURE__ */ jsx("li", { children: "Confirm any preparatory requirements." })] });
																		if (text.includes("cancel")) return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("li", { children: "Confirm cancellation reason and retention offer." }), /* @__PURE__ */ jsx("li", { children: "Escalate to human support if needed." })] });
																		return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("li", { children: "Ask a clarifying question to confirm the customer's intent." }), /* @__PURE__ */ jsx("li", { children: "Summarize the customer's request and propose next steps." })] });
																	})()
																})]
															})
														]
													...
													/* @__PURE__ */ jsxs("div", {
														...
														children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
															...
															className: "mt-2 flex flex-wrap gap-2",
															children: activeCustomerProfile.interestedProducts.map((product) => /* @__PURE__ */ jsx("span", {
																className: `${BADGE} bg-[#F8FAFC] text-[#334155]`,
																children: product
															}, product))
														})] })]
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: /* @__PURE__ */ jsxs("table", {
									...
									children: [/* @__PURE__ */ jsx("thead", {
										...
										children: [filteredCustomers.filter((customer) => !isPersonalByPhone(customer.phone)).map((customer) => /* @__PURE__ */ jsxs("tr", {
													...
													/* @__PURE__ */ jsxs("section", {
														...
														children: [
															...
															/* @__PURE__ */ jsx("div", {
																...
																children: TONES.map((option) => /* @__PURE__ */ jsxs("label", {
													...
													children: /* @__PURE__ */ jsxs("div", {
														...
														children: [
															...
															/* @__PURE__ */ jsx("div", {
																...
																children: testAiMessages.map((message) => /* @__PURE__ */ jsxs("div", {
																	...
																	children: [/* @__PURE__ */ jsx("div", {
																		...
																		children: /* @__PURE__ */ jsx("p", { children: message.text })
																	}), message.role === "ai" && message.source ? /* @__PURE__ */ jsxs("span", {
