                  ...
                  <div className="flex items-start justify-between gap-3 shrink-0">
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar">
                      <div className="space-y-6 rounded-[22px] border border-[#E5E7EB]/10 bg-white p-6 shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
                        ...
                        <div>
                          <p className="text-sm font-medium text-[#334155]">AI Conversation Summary</p>
                          <ul className="mt-2 list-disc list-inside text-sm text-[#475569] space-y-1">
                            <li>• Asked about internet packages</li>
                            <li>• Interested in Business Package</li>
                            <li>• Waiting for owner's reply</li>
                          </ul>
                          <p className="mt-3 text-xs text-[#94A3B8]">Summary generated by AI (placeholder). Integration point reserved.</p>
                        </div>
