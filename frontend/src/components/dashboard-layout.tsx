                ...
                <div id="ai-workspace-content" className="w-full scroll-mt-28">
                    ...
                    {activeWorkspaceSection === "Catalogue" && (
                      <div className="space-y-6 overflow-x-hidden">
                        <div className="grid gap-6 grid-cols-1 xl:grid-cols-[220px_minmax(0,1fr)] items-start">
                          <aside className="rounded-[20px] border border-[#E5E7EB] bg-[#F9FAFB] p-4 shadow-sm xl:sticky xl:top-6">
                                ...
                                return lessons.map((lesson, idx) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`w-full text-left flex items-center justify-between rounded-[10px] px-3 py-2 transition ${
                                        isActive
